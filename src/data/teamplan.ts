...
export type ProjectImpact = "low" | "medium" | "high" | "urgent";
...
export interface Project {
  ...
  impact?: ProjectImpact; // Optional - for project impact level
}
...
export const getProjectsForCell = (
  projects: Project[],
  personId: string,
  timeSlotId: string
) =>
  projects.filter(
    (project) =>
      project.personId === personId && project.timeSlotId === timeSlotId
  );
