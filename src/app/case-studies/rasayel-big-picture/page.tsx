  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        {/* Back Navigation */}
        <div
          className="mt-12 mb-36 animate-fade-in-up text-center"
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-lg text-slate-700">
            3 years of building Rasayel, a WhatsApp native platform for sales
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-base text-slate-700 leading-relaxed">
                I joined Rasayel as founding product designer and gradually took
                on broader responsibilities in product strategy and team
                coordination. My work involved creating prototypes, product
                planning, and helping establish clearer direction when facing
                ambiguous challenges. During my three years there, I was
                involved in several redesign efforts and the development of many
                features (as you can see below), while learning to balance user
                needs with business objectives and always questioning the
